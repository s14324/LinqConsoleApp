...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps.OrderByDescending(e => e.Salary).First();
        ...
        {
            var res = Emps.Join(Depts, e => e.Deptno,
                                d => d.Deptno,
                                (e, d) => new
                                {
                                    e.Ename,
        ...
        {
            var res = Emps.GroupBy(e => e.Job).Select(group => new
            {
                Praca = group.Key,
        ...
        {
            var res = Emps.SelectMany(e => Depts, (e, d) => new {e.Ename, e.Empno, d.Dname});
